...
Route::post("/htmleditor/autosave", [App\Http\Controllers\html_editor_controller::class, "autosave"])->name(
	"htmleditor.autosave",
);
...
Route::post("/users/delete_submissions/{user}", [
...
Route::get("/problems/downloadtestsdesc/{id}", [
	App\Http\Controllers\problem_controller::class,
	"downloadtestsdesc",
])->name("problems.downloadtestsdesc");
Route::get("/problems/downloadtestcases/{problem}/{assignment}/{type}", [
	App\Http\Controllers\problem_controller::class,
	"download_testcases",
...
Route::post("/problems/toggle_practice/{query?}", [
	App\Http\Controllers\problem_controller::class,
	"toggle_practice",
])->name("problems.toggle_practice");
Route::post("/problems/edit_tags/{problem?}", [App\Http\Controllers\problem_controller::class, "edit_tags"])->name(
	"problems.edit_tags",
);

Route::get("/submissions/assignment/{assignment_id}/user/{user_id}/problem/{problem_id}/view/{choose}", [
	App\Http\Controllers\submission_controller::class,
	"index",
])->name("submissions.index");
Route::get("/submissions/create/assignment/{assignment}/problem/{problem}/{oldsub?}", [
	App\Http\Controllers\submission_controller::class,
	"create",
])->name("submissions.create");
Route::post("/submissions/store/", [App\Http\Controllers\submission_controller::class, "store"])->name(
	"submissions.store",
);
Route::post("/submissions/get_template/", [App\Http\Controllers\submission_controller::class, "get_template"])->name(
	"submissions.get_template",
);
Route::post("/submissions/rejudge/", [App\Http\Controllers\submission_controller::class, "rejudge"])->name(
	"submissions.rejudge",
);

Route::middleware(["throttle:view_submit"])->group(function () {
	Route::post("/submissions/view_code/", [App\Http\Controllers\submission_controller::class, "view_code"])->name(
		"submissions.view_code",
	);
	Route::post("/submissions/view_status/", [App\Http\Controllers\submission_controller::class, "view_status"])->name(
		"submissions.view_status",
	);
});

Route::post("/submissions/select/", [App\Http\Controllers\submission_controller::class, "select_final"])->name(
	"submissions.select",
);
Route::get("/rejudge/{assignment}", [App\Http\Controllers\submission_controller::class, "rejudge_view"])->name(
	"submissions.rejudge_view",
);
Route::post("/submissions/rejudge_all_problems_assignment/", [
	App\Http\Controllers\submission_controller::class,
	"rejudge_all_problems_assignment",
])->name("submissions.rejudge_all_problems_assignment");
...
Route::get("/scoreboard/full/{id}", [App\Http\Controllers\scoreboard_controller::class, "index"])->name(
	"scoreboards.index",
);
...
Route::get("/assignment/{assignment}/{problem}/pdf", [App\Http\Controllers\assignment_controller::class, "show_pdf"])
	...
	->name("assignments.show_pdf");

Route::get("/assignment/download_submissions/{type}/{assignment_id}/", [
	App\Http\Controllers\assignment_controller::class,
	"download_submissions",
])->name("assignments.download_submissions");
Route::get("/assignment/download_all_submissions/{assignment_id}/", [
	App\Http\Controllers\assignment_controller::class,
	"download_all_submissions",
])->name("assignments.download_all_submissions");
Route::get("/assignment/reload_scoreboard/{assignment_id}/", [
	App\Http\Controllers\assignment_controller::class,
	"reload_scoreboard",
])->name("assignments.reload_scoreboard");

Route::get("/assignment/scores/accepted/", [App\Http\Controllers\assignment_controller::class, "score_accepted"])->name(
	"assignments.score_accepted",
);
Route::get("/assignment/scores/sum/", [App\Http\Controllers\assignment_controller::class, "score_sum"])->name(
	"assignments.score_sum",
);

Route::post("/assignment/check_open/", [App\Http\Controllers\assignment_controller::class, "check_open"])->name(
	"assignments.check_open",
);
...
Route::get("/scoreboard/simplify/{id}", [App\Http\Controllers\scoreboard_controller::class, "simplify"])->name(
	"scoreboards.simplify",
);
Route::get("/scoreboard/plain/{id}", [App\Http\Controllers\scoreboard_controller::class, "plain"])->name(
	"scoreboards.plain",
);
