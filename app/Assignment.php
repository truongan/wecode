...
class Assignment extends Model
{
    ...
    public function can_submit()
    {
        ...
        if (in_array( Auth::user()->role->name, ['student']) && $this->open == 0){
        ...
        elseif ( !$this->is_participant(Auth::user()->id) )
    ...
    public function is_participant($user_id)
    {
        ...
        return in_array([$user_id],[$this->lops->pluck('users')->collapse()->pluck('id')->unique()]);
    }
