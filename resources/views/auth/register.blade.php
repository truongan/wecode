                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        @if ($settings['registration_code'] > 0)
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="registration_code" type="text" class="form-control @error('registration_code') is-invalid @enderror" name="registration_code" value="{{ old('registration_code') }}" required autocomplete="registration_code" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="display_name" type="text" class="form-control @error('display_name') is-invalid @enderror" name="display_name" value="{{ old('display_name') }}"  autocomplete="display_name" autofocus>
