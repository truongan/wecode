...
<body id="body" class="fixed-nav ">
	...
	<script type="text/javascript" integrity="sha384-yExUdgygwAfJKHwoFyHp1o6g3zD70xx7448KbaORczrLujZgsrHHDBzlsnkwzRiN" src="{{ asset('assets/js/shj_functions.js') }}"></script>
	@yield('body_end')
</body>
</html>
