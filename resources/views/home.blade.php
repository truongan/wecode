...
@section("body_end")
	<script
		...
		src="{{ asset('assets/fullcalendar/main.min.
js') }}"
	></script>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="border shadow rounded-2">
				<div class="border-bottom p-2 lead text-center">
					<i class="bi bi-bell fs-5 color2"></i>
					...
					@foreach ($notifications as $notification)
						<div class="notif" id="number{{ $notification->id }}" data-id="{{ $notification->id }}">
							<div class="notif_title">
								...
								<span class="notif_meta" dir="ltr"> {{ $notification->created_at }} </span>
							</div>
